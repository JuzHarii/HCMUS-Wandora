...
export function MembersTab() {
  ...
  async function inviteMember(e: FormEvent) {
    ...
    setError("");
    try {
      const added = await collaborationApi.addMember(workspaceId, {
  ...
  async function changeRole(userId: string, newRole: string) {
    try {
      const updated = await collaborationApi.updateMemberRole(
        workspaceId,
        userId,
        { role: newRole },
      );
            ...
            {members.map((member) => (
              ...
              >
                ...
                {member.role?.toLowerCase() === "owner" ? (
                  ...
                  >
                    <Shield size={14} style={{ marginRight: "4px" }} /> Owner
                  </span>
                ) : (
                  <div
                    style={{
        ...
        {canEdit && (
          ...
          >
            ...
            >
              ...
              <button
                data-testid="member-invite-send"

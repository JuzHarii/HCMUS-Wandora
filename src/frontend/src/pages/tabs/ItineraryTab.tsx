...
export function ItineraryTab() {
  ...
  return (
    <div className="workspace-view workspace-itinerary-view">
      ...
      <section className="itinerary-ai-adjust" style={{ padding: '1rem', background: 'var(--color-surface-dim)', borderRadius: '0.75rem', marginBottom: '1.5rem' }}>
